...
--初始化系统管理员
insert into t_user(user_id,user_name,password) values ('root','系统管理员','123');
--初始化分销商级别
...
insert into t_client(id,pid,name,is_leaf,is_client,client_level_id,client_id) values (10005,10004,'北京医药股份有限公司','Y','Y','100','A0001');
...
insert into t_temi_client(id,pid,name,is_leaf,is_temi_client,temi_client_level_id,temi_client_id) values (20005,20004,'北京中医院','Y','Y','200','B0001');
